...
extern void   Model_generate1 (char *inputfile,char *idsfile, struct topo *topoinfo, struct opts *simu_opts, struct rlt *tmprlt);
extern void   check_topo(FILE *f_in, FILE *f_out, struct topo *topoinfo);
extern void   check_topo1(FILE *f_in, FILE *f_out, FILE *ids, struct topo *topoinfo);
